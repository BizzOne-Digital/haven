  ...
  return(
    <section style={{background:"#080808",padding:"130px 60px",textAlign:"center",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,maxWidth:"700px",margin:"0 auto"}}>
        ...
        <p className="reveal" style={{fontSize:"15px",letterSpacing:"2px",color:"rgba(240,240,240,0.4)",marginBottom:"50px",lineHeight:1.8}}>Same-week appointments available. No waiting around.<br/>Call us or book online and we will handle the rest.</p>
        <div className="reveal" style={{display:"flex",gap:"16px",justifyContent:"center",flexWrap:"wrap"}}>
          <Link href="/contact" className="clip-btn" data-hover style={{display:"inline-flex",alignItems:"center",gap:"10px",background:"#e8001d",color:"white",padding:"18px 50px",fontFamily:"'Orbitron',sans-serif",fontSize:"12px",fontWeight:700,letterSpacing:"4px",textTransform:"uppercase",textDecoration:"none",transition:"all .4s"}}
          ...
          <Link href="/services" className="clip-btn" data-hover style={{display:"inline-flex",alignItems:"center",gap:"10px",background:"transparent",color:"#f0f0f0",padding:"18px 50px",border:"1px solid rgba(240,240,240,0.2)",fontFamily:"'Orbitron',sans-serif",fontSize:"12px",fontWeight:700,letterSpacing:"4px",textTransform:"uppercase",textDecoration:"none",transition:"all .3s"}}
          ...
          onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(240,240,240,0.2)";e.currentTarget.style.color="#f0f0f0";e.currentTarget.style.transform="none"}}>View Services</Link>
        </div>
        <div className="reveal" style={{display:"flex",gap:"44px",justifyContent:"center",marginTop:"56px",flexWrap:"wrap"}}>
          {[{l:"Phone",v:"(555) 240-Haven"},{l:"Hours",v:"Mon to Sat  8AM to 6PM"},{l:"Location",v:"123 Performance Drive"}].map(c=>(
            <div key={c.l} style={{textAlign:"center"}}>
              <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:"9px",letterSpacing:"4px",color:"#e8001d",textTransform:"uppercase",marginBottom:"4px"}}>{c.l}</div>
              <div style={{fontSize:"13px",color:"rgba(240,240,240,0.5)",letterSpacing:"1px"}}>{c.v}</div>
            </div>
          ))}
        </div>
      </div>
