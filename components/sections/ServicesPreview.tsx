    ...
    >
          ...
          {services.map((s) => (
            ...
            >
              ...
              <div style={{ position: "relative", height: "160px", overflow: "hidden" }}>
                ...
                />
                <div style={{ position: "absolute", top: "16px", left: "16px", color: "#e8001d" }}>
                  {s.icon}
                </div>
              </div>
      ...
      <style>{`
        .service-card:hover .service-img {
          filter: brightness(0.75) saturate(1.2) !important;
