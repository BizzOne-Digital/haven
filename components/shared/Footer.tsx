...
const col1=[{l:"Tire Installation",h:"/services"},{l:"Wheel Alignment",h:"/services"},{l:"Tire Balancing",h:"/services"},{l:"Seasonal Change",h:"/services"},{l:"Performance Wheels",h:"/services"},{l:"Ceramic Coating",h:"/services"},{l:"Window Tint",h:"/services"},{l:"Tire Repair",h:"/services"}];
const col2=[{l:"Michelin",h:"/brands"},{l:"Pirelli",h:"/brands"},{l:"Bridgestone",h:"/brands"},{l:"Toyo Tires",h:"/brands"},{l:"Yokohama",h:"/brands"},{l:"Nitto",h:"/brands"}];
const col3=[{l:"About Us",h:"/about"},{l:"Our Gallery",h:"/gallery"},{l:"Contact",h:"/contact"},{l:"Book Appointment",h:"/contact"},{l:"Privacy Policy",h:"/contact"}];
      ...
      <div style={{maxWidth:"1400px",margin:"0 auto",padding:"70px 60px 50px",display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:"60px"}} className="footer-grid">
        <div>
          ...
          <div style={{display:"flex",gap:"10px"}}>
            {["IG","FB","YT","X"].map(s=>(
              <a key={s} href="#" data-hover style={{width:"36px",height:"36px",border:"1px solid rgba(255,255,255,0.1)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Orbitron',sans-serif",fontSize:"9px",fontWeight:700,color:"rgba(240,240,240,0.35)",textDecoration:"none",transition:"all .3s"}}
              onMouseEnter={e=>{e.currentTarget.style.borderColor="#e8001d";e.currentTarget.style.color="#e8001d";e.currentTarget.style.background="rgba(232,0,29,0.08)"}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,0.1)";e.currentTarget.style.color="rgba(240,240,240,0.35)";e.currentTarget.style.background="transparent"}}
              >{s}</a>
            ))}
          </div>
        </div>
        {[{title:"Services",items:col1},{title:"Brands",items:col2},{title:"Company",items:col3}].map(col=>(
          <div key={col.title}>
            <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:"10px",letterSpacing:"4px",color:"#f0f0f0",marginBottom:"20px",textTransform:"uppercase"}}>{col.title}</div>
            <ul style={{listStyle:"none",display:"flex",flexDirection:"column",gap:"10px"}}>
              {col.items.map(item=>(
                <li key={item.l}>
                  <Link href={item.h} data-hover style={{fontSize:"13px",color:"rgba(240,240,240,0.3)",textDecoration:"none",letterSpacing:"0.5px",transition:"color .3s"}}
