        ...
        <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr", gap:"60px", alignItems:"start" }} className="contact-grid">
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:"2px" }}>
            {[
              ...
              { icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="#e8001d" strokeWidth="1.5" strokeLinecap="round"><circle cx="10" cy="10" r="8"/><path d="M10 5 L10 10 L14 12"/></svg>, label:"Hours", val:"Mon to Sat  11AM to 8PM", sub:"Closed Sundays and Holidays" },
            ].map(i => (
