          ...
          <div style={{position:"relative",paddingLeft:"40px"}}>
            ...
            {milestones.map((m,i)=>(
              <div key={m.year} style={{position:"relative",marginBottom:"44px",paddingLeft:"30px"}}>
                ...
                <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:"12px",fontWeight:700,color:"#e8001d",letterSpacing:"3px",marginBottom:"8px"}}>{m.year}</div>
                <p style={{fontSize:"14px",color:"rgba(240,240,240,0.58)",lineHeight:1.75}}>{m.event}</p>
              </div>
            ))}
          </div>
        </div>
